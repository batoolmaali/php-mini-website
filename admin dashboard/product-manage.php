  ...
  if(in_array( $fileActualExt, $allowed )){
      if($fileError === 0){
            ...
            if( $filesize < 1000000){
              ...
              $connection->query($sql = "INSERT INTO products (product_name,product_des, product_price,category_name, product_image)
               Values ('$name','$desc', '$price', '$cat','$fileDestination')"); 
            } else {
  ...
  <head>
    ...
    <body>
        ...
        <div class="sidenav">
          ...
          <a href="product-manage.php" style="color: white; margin-top: 0; background-color: teal"><i class="fa fa-bar-chart" aria-hidden="true" style="margin-right:10px"></i>product</a>
        ...
        <form action=""  method="post" enctype="multipart/form-data"
         style="width: 800px; margin-left: 500px; border: 1px solid grey; overflow: hidden; padding: 10px; margin-top: 5%;font-size:20px; background-color: white;">
         <h3 style="text-align: center;background-color: #404040; color:white;   height:100px;line-height:100px">Add A New product</h3>
            
            <label for="fname">product name:</label><br>
            <input type="text" id="fname"    name="name" style="width:100%"><br><br>
            ...
            <input type="text" id="fname" name="price" style="width:100%"><br><br>
          ...
          <table class="table table-striped" style="width: 800px; margin-left: 500px; margin-top: 2%;">
...
?>  
  <?php foreach($products as $key=>$val){ ?>
   ...
   <tr>
       ...
       <td><?php echo $val['product_des']?></td>
       <td><?php echo $val['product_price']?></td>
       <td><?php echo $val['category_name']?></td>
        <td><img width="100px" height="100px" src="<?php echo $val['product_image']?>" alt="image"></td>
       <td> 
        <form method="post" acttion="delprod.php">
                <input hidden name="uname" value=<?php echo $val['product_name']; ?>/> 
